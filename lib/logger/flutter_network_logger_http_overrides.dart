...
class FlutterNetworkLoggerHttpOverrides extends HttpOverrides {
  final HttpOverrides? _previous;

  FlutterNetworkLoggerHttpOverrides() : _previous = HttpOverrides.current;
...
class _LoggingHttpClientRequest implements HttpClientRequest {
  ...
  Future<HttpClientResponse> close() async {
    ...
    final entry = LogEntry(
      ...
      requestBody: _bodyBuffer.toString().isEmpty
          ? null
          : _bodyBuffer.toString(),
    ...
    try {
      ...
      FlutterNetworkLoggerNotifier.instance.updateLog(id, (e) {
      ...
      FlutterNetworkLoggerNotifier.instance.updateLog(id, (entry) {
